...
<?php
	...
	$date2 = $_GET['date2'];
 	$id    = $_GET['id'];
	$string =  $_GET['string'];		
	$me  = "Sarah ❤ Eloïse 🇫🇷(@saraaah_lapute)";
	$BEARER_TOKEN= "AAAAAAAAAAAAAAAAAAAAAL5gPAEAAAAAnqtd1eUwaH1pg0qQovPFhNDS%2F8Q%3D6UOLejv3iuXNRykVQNgsAkahdBlo2RIjRcDwM65efNpENlWJqR";
...
<?php
	...
	while ($ligne = mysqli_fetch_array($req1))
	{
		...
		if ($ligne['id2'] == 871066677819183104)
		{
			?>
			<div class="div4elements">
			<div class="photo"><img style="border-radius: 3px; object-fit: contain;" src="http://pbs.twimg.com/profile_images/1461386867413237762/gqtsVer1_normal.jpg" ></div>
