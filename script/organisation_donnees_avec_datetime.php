...
if ($db_select)
$req1 = mysqli_query($conn, "DROP DATABASE twitter3");
$req2 = mysqli_query($conn, "CREATE DATABASE twitter3 DEFAULT CHARACTER SET utf8  DEFAULT COLLATE utf8_general_ci;");
$db_select =  mysqli_select_db($conn, 'twitter3');
